...
const Certificates = () => {
  ...
  const certificates = [
  {
    ...
    year: '2021',
    file: '/certificados/Semana_Agronomia.pdf',
  },
  {
    name: 'Python Avançado',
    institution: 'Curso',
    year: '2022',
    file: '/certificados/Python_Avancado.pdf',
  },
  {
    name: 'Produtividade em Canavial',
    institution: 'Curso / Pesquisa',
    year: '2020',
    file: '/certificados/Produtividade_Canavial.pdf',
  },
  {
    name: 'Orientação por Satélite',
    institution: 'Curso',
    year: '2020',
    file: '/certificados/Orientacao_Satelite.pdf',
  },
  {
    name: 'John Deere',
    institution: 'John Deere',
    year: '2021',
    file: '/certificados/Jonh_deere.pdf',
  },
  {
    name: 'Horus',
    institution: 'Plataforma / Curso',
    year: '2021',
    file: '/certificados/Horus.pdf',
  },
  {
    name: 'Eu Esri',
    institution: 'Esri',
    year: '2022',
    file: '/certificados/EuEsri.pdf',
  },
  {
    name: 'AgroHacka',
    institution: 'Hackathon',
    year: '2023',
    file: '/certificados/AgroHacka.pdf',
  },
  {
    name: 'AgroCAD',
    institution: 'Curso',
    year: '2021',
    file: '/certificados/AgroCad.pdf',
  },
  {
    name: 'Agricultura Orgânica',
    institution: 'Curso',
    year: '2022',
    file: '/certificados/AgriculturaOrganica.pdf',
  },
  {
    name: 'Agricultura Sustentável',
    institution: 'Curso',
    year: '2022',
    file: '/certificados/Agricultura_Sustentavel.pdf',
  },
];
